...
public class AstolfoSchoolGirlEntity extends AstolfoFabricEntity {
    public AstolfoSchoolGirlEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
